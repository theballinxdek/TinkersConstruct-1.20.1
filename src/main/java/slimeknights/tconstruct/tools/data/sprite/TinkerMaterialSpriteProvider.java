...
import static slimeknights.tconstruct.tools.data.sprite.TinkerPartSpriteProvider.PLATE;
...
public class TinkerMaterialSpriteProvider extends AbstractMaterialSpriteProvider {
  ...
  protected void addAllMaterials() {
    ...
    buildMaterial(IMaterial.UNKNOWN_ID)
      .meleeHarvest().ranged().statType(RepairKitStats.ID)
    ...
    buildMaterial(MaterialIds.leather)
      .statType(RepairKitStats.ID, StatlessMaterialStats.BINDING.getIdentifier())
    ...
    buildMaterial(MaterialIds.string)
      .statType(StatlessMaterialStats.BINDING.getIdentifier(), StatlessMaterialStats.BOWSTRING.getIdentifier(), RepairKitStats.ID)
      .fallbacks("primitive")
    ...
    buildMaterial(MaterialIds.oak)
      .meleeHarvest().ranged().statType(WOOD)
      .fallbacks("wood", "stick", "primitive")
    ...
    buildMaterial(MaterialIds.copper)
      .meleeHarvest().ranged().statType(PLATE)
      .fallbacks("metal")
    ...
    buildMaterial(MaterialIds.enderbark)
      .meleeHarvest().ranged().statType(WOOD)
      .fallbacks("wood", "primitive")
    ...
    // plate
    buildMaterial(MaterialIds.obsidian).statType(PLATE).fallbacks("rock").colorMapper(obsidianPalette);
    buildMaterial(MaterialIds.debris).statType(PLATE).fallbacks("rock").colorMapper(ancientDebrisPalette);
    ...
    buildMaterial(MaterialIds.gold)
      .statType(RepairKitStats.ID).statType(PLATE).statType(SLIMESUIT)
      .fallbacks("metal")
    ...
    buildMaterial(MaterialIds.brass).statType(PLATE).fallbacks("metal").colorMapper(brassPalette);
    buildMaterial(MaterialIds.uranium).statType(PLATE).fallbacks("metal").colorMapper(uraniumPalette);
